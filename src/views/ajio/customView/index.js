        ...
        <Container style={{ marginTop: '10%' }}>
            ...
            <Row className="m-5">
                <Col className="col-6 pt-5">
                    ...
                    <p className="mb-0">Get training on everything,how</p>
                    <p className="mb-0">selling on Ajio works,day to day</p>
                    <p className="mb-0">operations, how to check your</p>
                    <p className="mb-0">orders, how to manage your</p>
                    <p className="mb-0">Ajio account and so on.</p>
                </Col>
                <Col className="col-6">
