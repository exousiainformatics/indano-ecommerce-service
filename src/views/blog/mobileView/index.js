        ...
        <Container className="p-0" style={{ marginTop: '17%' }}>
            <div className='head '>
                <div className='text-wrap pl-4 pb-3 pt-4 mt-5'>
                    <h2 className="text-light font-weight-bold pt-0">E-commerce: Yesterday, Today, & Tomorrow!</h2>
                    <p className='text-light'>Upasana</p>
                    <NavLink to='/blog/blog1'><Button className='blogbtnMobile'>Read Full Blog</Button></NavLink>
                    <Image src={left} height={'30px'} className="ml-3 cursor" />
                    <Image src={right} height={'30px'} className="ml-2 cursor" />
                </div>
            </div>
            <h2 className="serviceHeadText text-center mt-4 mb-4">All Blog Posts</h2>
            ...
            <div className='blogCard mt-4 mb-5'>
                <Image src={blogimg} width={'100%'} />
                <div className='ml-4 mr-4'>
                    <p className="text-muted font-weight-bold pt-2 mb-0">Marketing & Promotion</p>
                    <h4 className="text-light-title font-weight-bold pt-0">E-commerce <br />Tips & Advice</h4>
